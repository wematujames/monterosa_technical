...
const getMetrics = (0, asyncHandler_1.default)((req, res, next) => {
    ...
    return res.status(200).json(new SuccessResponse_1.default(200, "Success", Object.assign(Object.assign({}, metrics_1.default), { avg_processing_time: parseFloat(avgJobDuration + "").toFixed(2) + "s", processing_times: undefined })));
});
